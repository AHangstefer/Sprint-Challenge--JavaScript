...
// or surface area. Cuboids are similar to cubes but do not have even sides. Follow the
// steps in order to accomplish this challenge.
...
const cubie = new CuboidMaker(2,3,4);
console.log(cubie);

/* == Step 2: Volume Method ==
  Create a method using CuboidMaker's prototype that returns the volume of a given cuboid's 
...
*/
const cuboid = new CuboidMaker(4,5,6);
