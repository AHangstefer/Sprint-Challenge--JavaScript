...
// Given this zoo data from around the United States, follow the 
//instructions below.  Use the specific array methods in the requests
...
The zoos want to display both the scientific name and the animal name in
 front of the habitats. Populate the displayNames array with only the animal_name 
 and scientific_name of each animal. displayNames will be an array of strings, and
  each string should follow this pattern: "Name: Jackal, asiatic, Scientific: 
  Canis aureus."
...
The zoos are concerned about animals with a lower population count. Using filter, create
 a new array of objects called lowPopulationAnimals which contains only the animals
...
*/
const populationTotal = zooAnimals.reduce((animals, index) =>
animals + index.population, 0);
